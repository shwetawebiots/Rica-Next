...
const LoaderFlight: React.FC<ILoaderProps> = ({ loaderTimeout }) => {
  ...
  return (
    <div className={`loader-wrapper inner-loader ${show ? "" : "loaderhide"}`}>
      <div className="loader">
        <div className="animation">
          ...
          <svg className="animation__plane" data-name="svgi-plane" viewBox="0 0 135.67 49.55">
            ...
            <ellipse cx="65.549591" cy="29.448534" fill="#fff" stroke="#464646" strokeLinecap="square" strokeLinejoin="round" strokeWidth="1" rx="1.3354006" ry="1.6400863" />
          </svg>
