...
const CabLeftSidebar: FC = () => {
  ...
  return (
    <CustomLayout title="light_header" loader="pre" logo="dark" userBgClass="user user-light">
      ...
      <Search />
      <GridView type={"cab"} size={3} topFilter={false} value={data} gridType="grid-view" grid4Img={true} gridOption={false} side="left" />
    </CustomLayout>
  );
};

export default CabLeftSidebar;
