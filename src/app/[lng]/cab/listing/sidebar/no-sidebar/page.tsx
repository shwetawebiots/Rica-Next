...
const CabNoSidebar: FC = () => {
  ...
  return (
    <CustomLayout title="light_header" loader="no-sidebar" logo="dark" userBgClass="user user-light">
      ...
      <Search />
      <GridView latestFilter type={"cab"} size={3} topFilter={false} value={data} gridType="grid-view" grid4Img={true} gridOption={false} side="no" />
    </CustomLayout>
  );
};

export default CabNoSidebar;
