...
const GridFourCab: FC = () => {
  ...
  return (
    <CustomLayout title="light_header custom-user-header" loader="right">
      <BannerCab title="cab search" />
      <Search />
      <GridView latestFilter type={"cab"} size={4} topFilter={true} value={data} gridType="grid-view" grid4Img={true} gridOption={true} side="no" />
    </CustomLayout>
  );
};

export default GridFourCab;
